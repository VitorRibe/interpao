...
async def listar_documentos(
    ...
    """Retorna todas as categorias e os documentos internos cadastrados."""
...
async def upload_documento(
    ...
    current_user: dict = Depends(ValidateAdminAccess), # Apenas administradores/gestores podem fazer upload
    db: AsyncSession = Depends(get_async_db)
):
    """Recebe um arquivo e associa a uma categoria existente ou nova."""
...
async def deletar_documento(
    ...
    """Exclui permanentemente o arquivo do storage do Supabase e do banco de dados."""
    use_case = DocumentoUseCase(db)
